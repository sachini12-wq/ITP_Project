...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    // For demo purposes, we'll just redirect to admin dashboard if email contains 'admin'
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100">
      ...
      >
        <div>
          ...
          <h2 className="mt-6 text-center text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-purple-500">
            Welcome back
          </h2>
